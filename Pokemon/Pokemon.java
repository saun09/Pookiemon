...
public class Pokemon {
    ...
    public Pokemon(String pokemonType, List<Attack> listOfAttacks) {
        ...
        if (listOfAttacks == null || listOfAttacks.isEmpty()) {
            throw new IllegalArgumentException("List of attacks cannot be null or empty");
        }
    ...
    public void displayDetails() {
        try {
            ...
            System.err.println("Error displaying Pokemon details: " + e.getMessage());
        }
    }
    ...
    public void takesDamage(Attack attack) {
        ...
        try {
            ...
            System.err.println("Error while taking damage: " + e.getMessage());
        }
    }
    ...
    public void heal(int healByAmount) {
        ...
        try {
            ...
            System.err.println("Error while healing: " + e.getMessage());
        }
    }
    ...
    public void displayBattleDetails() {
        try {
            ...
            System.err.println("Error displaying battle details: " + e.getMessage());
        }
    }
    ...
    public void resetAttackUses() {
        try {
            ...
            System.err.println("Error resetting attack uses: " + e.getMessage());
        }
    }
